namespace AntiDebugLib.Check.Memory.AntiStepOver
{
    ...
    /// </list>
    /// </summary>
    public class AntiStepReadFile : NativeCheckBase
    {
        public override string Name => "Anti Step-over - Memory overwrite with ReadFile";

        public override CheckReliability Reliability => CheckReliability.Great;

        public override CheckResult CheckActive()
            => CallNativeCheck(NativeCheckType.Memory_AntiStepOver_ReadFile);
    }
}
