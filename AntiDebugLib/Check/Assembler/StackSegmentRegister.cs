namespace AntiDebugLib.Check.Assembler
{
    ...
    /// </list>
    /// </summary>
    public class StackSegmentRegister : NativeCheckBase
    {
        public override string Name => "Stack segment register (MOVSS)";

        public override CheckReliability Reliability => CheckReliability.Perfect;

        public override CheckResult CheckActive()
            => CallNativeCheck(NativeCheckType.Assembler_StackSegmentRegister);
    }
}
