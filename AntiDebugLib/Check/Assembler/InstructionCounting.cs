namespace AntiDebugLib.Check.Assembler
{
    ...
    /// </list>
    /// </summary>
    public class InstructionCounting : NativeCheckBase
    {
        public override string Name => "Instruction Counting";

        public override CheckReliability Reliability => CheckReliability.Perfect;

        public override CheckResult CheckActive()
            => CallNativeCheck(NativeCheckType.Assembler_InstructionCounting);
    }
}
