namespace AntiDebugLib.Check.Memory.AntiStepOver
{
    ...
    /// </list>
    /// </summary>
    public class AntiStepDirect : NativeCheckBase
    {
        public override string Name => "Anti Step-over - Direct memory overwrite";

        public override CheckReliability Reliability => CheckReliability.Great;

        public override CheckResult CheckActive()
            => CallNativeCheck(NativeCheckType.Memory_AntiStepOver_Direct);
    }
}
