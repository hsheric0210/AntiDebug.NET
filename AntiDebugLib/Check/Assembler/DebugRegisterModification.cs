namespace AntiDebugLib.Check.Assembler
{
    ...
    /// </list>
    /// </summary>
    public class DebugRegisterModification : NativeCheckBase
    {
        public override string Name => "Debug Register Modification on SEH";

        public override CheckReliability Reliability => CheckReliability.Perfect;

        public override CheckResult CheckActive()
            => CallNativeCheck(NativeCheckType.Assembler_DebugRegisterModification);
    }
}
